...
The working tree passes the validator and all 394 unit/CLI tests (20 test files, collected
2026-09-03). These commands must be rerun after every subsequent code or release-metadata
