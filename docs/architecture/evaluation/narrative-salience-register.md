...
## 17. Held-out refereed papers as labels: register and salience measured (v0.30.0)
...
|---|---:|---:|---:|---:|---:|---:|
| published-heldout | 203 | 9,793 | **0.936** | **0.991** | 0.966 | **1.165** |
| published-insample | 544 | 10,372 | 0.835 | 0.474 | 0.914 | 1.053 |
...
Rank AUC, machine over held-out published: **register 0.080**,
**salience 0.770**.
...
2012–2018 (median 2016), with no overlap. Reading the 0.991 → 0.474 gap as
...
**2,287** flags raised on held-out papers, **72.7% would be suppressed** by
the paper's own bank membership. The in-sample view of this axis is ~3.7×
...
On refereed papers the axis never saw, register fires on **93.6% of documents
at 0.991 findings per 1,000 words** — about ten advisories on a median
9,793-word paper. Its rank AUC against machine text is **0.080**: it fires
