# Changelog archive — v0.26.2 and earlier

Older entries moved out of [CHANGELOG.md](CHANGELOG.md) on 2026-08-25 so the
current file stays readable. Nothing here is edited; the history is verbatim.
The live changelog carries the current release and the one before it.
